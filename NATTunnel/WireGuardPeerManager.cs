...
internal class WireGuardPeerManager
{
    ...
    private void UpdateConfig()
    {
        ...
        // Write the new config. The live interface is updated separately by the backend's native
        // WireGuardSetConfiguration path (WindowsWireGuardBackend.ApplyFullConfig) — not from here.
